        ...
        <div className="mx-auto max-w-7xl">
          {banners?.length === 0 ? (
            <motion.div
              ...
              className="text-center py-12 sm:py-16 lg:py-20 bg-[#068DF1] backdrop-blur-lg rounded-2xl sm:rounded-3xl border border-[#068DF1]/10"
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#1FA0FF] mb-2 sm:mb-3">
                No Banner Found
              </h3>
